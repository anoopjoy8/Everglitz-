  ...
  <div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form class="forms-sample" role="form" action="{{url('admin/list-portfolio')}}" method="post" enctype="multipart/form-data" id="form">
          @csrf
          <div class="row">
            <div class="col-md-12">
          ...
          <a href="{{ url('admin/list-portfolio')}}"><button class="btn btn-light">Cancel</button></a>
          @csrf
        </form>
      </div>
    </div>
    ...
    <div class="card-body">
      <div class="row">
        ...
        <div class="col-md-4 menu-button">
          <a href="{{ url('admin/add-portfolio')}}">
            <button type="button" class="btn btn-primary btn-icon-text">
              <i class="fa-solid fa-file-lines"></i>
              Add
            </button>
          </a>
          <a href="{{ url('admin/list-portfolio?search=1')}}">
      ...
      <div class="table-responsive">
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="{{ url('admin/update-portfolio?edit='.$val->id.'&page='.$page) }}">
                  <button type="button" class="btn btn-sm btn-success btn-icon no-round">
                    <i class="fa-solid fa-pen-to-square"></i>
                  </button>
                </a>
                <a href="{{ url('admin/delete-portfolio?id='.$val->id.'&page='.$page) }}" onClick="return confirm('Do you want to delete this Portfolio?')">
        ...
        <div class="template-demo">
          <div class="btn-group" role="group" aria-label="Basic example">
            ...
            <a href="{{ url('admin/list-portfolio?page='.$val)}}">
