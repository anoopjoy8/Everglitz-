...
<div class="col-12 grid-margin stretch-card">
  <div class="card">
    <div class="card-body">
      ...
      <form class="forms-sample" role="form" action="{{ empty($id) ? url('admin/add-portfolio') : url('admin/update-portfolio')  }}" method="post" enctype="multipart/form-data" id="form">
        @csrf
        <div class="row">
          <div class="col-md-12">
              ...
              <div class="field" align="left">
                ...
                <span id="image_div">
                  ...
                  <span class="pip"><img src="{{ url('thumbnail/'.$val->image) }}" class="imageThumb" />
                    <br>
                    <span class="removes" onClick="DeletepImage({{$val->id}},{{$val->portfolio_id}})"> <i class="fa-solid fa-trash-can"></i></span>
                  </span>
                  @endif
                  @endforeach
                  @endif
